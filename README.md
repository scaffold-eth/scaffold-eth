# 🏗 scaffold-eth Freelancer

> is everything you need to get started building decentralized applications on Ethereum and get paid! 🚀 
...
```bash
git clone https://github.com/austintgriffith/scaffold-eth.git app
cd app
yarn install
yarn chain
```
...
✏️ Make small changes to `Freelancer.sol` and watch your app auto update!
