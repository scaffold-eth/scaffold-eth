# 🏗 Scaffold-ETH - 🎟 Simple NFT Example (NextJS version)
...
```
git clone https://github.com/austintgriffith/scaffold-eth.git simple-nextjs-nft-example
```
```
...
> Note: `yarn deploy --reset` to get a fresh localost deployment anytime. 
...
📝 Edit your frontend pages `App.jsx` in `packages/react-app/pages`
...
```
> ✏️ Edit your frontend `_app.js` in `packages/react-app/pages` to change the `targetNetwork` to wherever you deployed your contract:
...
Check out all the [active branches](https://github.com/austintgriffith/scaffold-eth/branches/active), [open issues](https://github.com/austintgriffith/scaffold-eth/issues), and join/fund the 🏰 [BuidlGuidl](https://BuidlGuidl.com)!
 ...
 - 🎟  [Create your first NFT](https://github.com/austintgriffith/scaffold-eth/tree/simple-nextjs-nft-example)
