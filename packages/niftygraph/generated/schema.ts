...
export class File extends Entity {
  ...
  save(): void {
    ...
    assert(
      ...
      "Cannot save File entity with non-string ID. " +
  ...
  static load(id: string): File | null {
    return store.get("File", id) as File | null;
  }
  ...
  set likers(value: Array<string> | null) {
    if (value === null) {
      ...
      this.set("likers", Value.fromStringArray(value as Array<string>));
    }
  }
...
export class Ownership extends Entity {
  ...
  get ownerApproval(): boolean {
    let value = this.get("ownerApproval");
    return value.toBoolean();
  }

  set ownerApproval(value: boolean) {
    this.set("ownerApproval", Value.fromBoolean(value));
  }

  get newOwnerAcknowledgement(): boolean {
    let value = this.get("newOwnerAcknowledgement");
    return value.toBoolean();
  }

  set newOwnerAcknowledgement(value: boolean) {
    this.set("newOwnerAcknowledgement", Value.fromBoolean(value));
  }
}
