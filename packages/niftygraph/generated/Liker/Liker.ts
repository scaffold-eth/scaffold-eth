...
export class Liker extends ethereum.SmartContract {
  ...
  like(contractAddress: Address, target: BigInt, _fileUrl: string): BigInt {
    let result = super.call("like", "like(address,uint256,string):(uint256)", [
      ethereum.Value.fromAddress(contractAddress),
      ethereum.Value.fromUnsignedBigInt(target),
      ethereum.Value.fromString(_fileUrl)
    ]);
  ...
  try_like(
    ...
    let result = super.tryCall(
      "like",
      "like(address,uint256,string):(uint256)",
      [
        ethereum.Value.fromAddress(contractAddress),
        ethereum.Value.fromUnsignedBigInt(target),
        ethereum.Value.fromString(_fileUrl)
  ...
  likeWithSignature(
    ...
    let result = super.call(
      "likeWithSignature",
      "likeWithSignature(address,uint256,address,string,bytes):(uint256)",
      [
        ethereum.Value.fromAddress(contractAddress),
        ethereum.Value.fromUnsignedBigInt(target),
        ethereum.Value.fromAddress(liker),
