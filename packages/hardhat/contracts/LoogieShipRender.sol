  ...
  function renderShip(bytes3 wheelColor, bytes3 mastheadColor, bytes3 flagColor, bytes3 flagAlternativeColor, bool loogieMasthead, bool loogieFlag) public pure returns (string memory) {
    ...
    if (loogieMasthead) {
      masthead = string(abi.encodePacked(
        '<g class="cls-14">',
          '<path class="cls-19" d="M54.16,132.05l1.58.8A4.38,4.38,0,0,0,54.16,132.05Z"/>',
          '<path class="cls-19" d="M129.26,225.71c.72-6.44-16.82-10.51-16.93-10.51-7.67-1-17.84-16.86-26.75-21.29-4.16-2.67-12-4.77-12.71-9,9.76-7.41,21.79,22.67,22.15,11.67,10.58,4.09,6.86-7.68-1.63-6.23C90.58,185.39,81,179,75.07,177c-23.74.41-8.36-2.75-24.78-12.51-37.37-1.22,61.23,43.75,65.07,64.29,0-1,.68-3.42.59-4C118.25,225.77,124.43,228.17,129.26,225.71Z"/>',
        '</g>',
      ...
      masthead = string(abi.encodePacked(
        '<g class="cls-14">',
          '<path class="cls-19" d="M143.84,241.42l.56.11,0-.57A24.13,24.13,0,0,0,137,222.05a44.26,44.26,0,0,0-3.51-3.1c-2.33-1.91-4.18-3.41-5.64-7.26A85,85,0,0,0,114.26,188a5.9,5.9,0,0,0,1.15-5.6,6.43,6.43,0,0,0-.34-1.05L82.76,165c-.82.2-1.59.37-2.29.5a60.12,60.12,0,0,0-11.5-2,6.34,6.34,0,0,0-6.12-3.73,6.19,6.19,0,0,0-2.22.54,6.33,6.33,0,0,0-2.05-4h0a6.34,6.34,0,0,0-8.94.49,5.92,5.92,0,0,0-1,1.51c14.5,8.67,71.64,43.65,72.59,57a96.4,96.4,0,0,0,4.26,21.44,13.85,13.85,0,0,0,2.48-4A33,33,0,0,0,143.84,241.42Z"/>',
        '</g>',
