...
contract YourToken is YourCollectible {
     ...
     */
    function TokenTransfer(address recipient, uint256 amount)
        public
        virtual
        returns (bool)
    {
    ...
    function TokenAllowance(address owner, address spender)
        public
        view
        virtual
        returns (uint256)
     ...
     * - `spender` cannot be the zero address.
     */
    function TokenIncreaseAllowance(address spender, uint256 addedValue)
        public
        virtual
        returns (bool)
    {
     ...
     * `subtractedValue`.
     */
    function TokenDecreaseAllowance(address spender, uint256 subtractedValue)
        public
        virtual
        returns (bool)
    {
