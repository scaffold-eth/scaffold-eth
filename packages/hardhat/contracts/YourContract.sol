...
contract YourCollectible is ERC721Enumerable, Ownable {
                ...
                Base64.encode(
                    bytes(
                          abi.encodePacked(
                              ...
                              id.toString(),
                              '", "attributes": [{"trait_type": "color", "value": "brown"',
                              '}], "owner":"',
  ...
  function renderTokenById(uint256 id) public view returns (string memory) {
    ...
    if(sips[id] == 12) {
      fluid = '<path class="cls-2" d="M589.5 669.5s183-11.11 186 4-3 20-36.08 32.16c0 0-111.84 5.92-135.84-13.08 0 0-10.08-3.08-14.08-23.08" transform="translate(-581.04 -57.08)"/><path class="cls-6" d="M591.5 670.5s87-19 185 1c-6.11-1.25-105 23-185-1Z" transform="translate(-581.04 -57.08)"/>';
    }
    if(sips[id] == 13) {
