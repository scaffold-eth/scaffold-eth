...
contract CurlyCoin is ERC20_Token, ERC20_Details {
	...
	/**
	 * Constructor of CurlyCoin
	 * @param _totalSupply Total amount of tokens initially issued
	 */
	function CurlyCoin (uint256 _totalSupply, string _name, string _symbol, uint8 _decimals) 
