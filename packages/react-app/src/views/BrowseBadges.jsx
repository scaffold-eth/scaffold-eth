...
export default function BrowseBadges({
  ...
  let contractRef
  if (externalContracts[selectedChainId] && externalContracts[selectedChainId].contracts && externalContracts[selectedChainId].contracts.REMIX_REWARD) {
  ...
  return (
    <div style={{ paddingTop: '36px' }}>
      <svg style={{padding: '24px', fill: '#007aa6', width: '200px', float: 'left', marginTop: '64px'}} id="Ebene_2" data-name="Ebene 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 105 100">
    ...
    <path d="M75.68,46.9,82,45a.09.09,0,0,0,.08-.09,29.91,29.91,0,0,0-.87-6.94.11.11,0,0,0-.09-.08l-6.43-.58a.1.1,0,0,1-.06-.18l4.78-4.18a.13.13,0,0,0,0-.12,30.19,30.19,0,0,0-3.65-6.07.09.09,0,0,0-.11,0l-5.91,2a.1.1,0,0,1-.12-.14L72.19,23a.11.11,0,0,0,0-.12,29.86,29.86,0,0,0-5.84-4.13.09.09,0,0,0-.11,0l-4.47,4.13a.1.1,0,0,1-.17-.07l.09-6a.1.1,0,0,0-.07-.1,30.54,30.54,0,0,0-7-1.47.1.1,0,0,0-.1.07l-2.38,5.54a.1.1,0,0,1-.18,0l-2.37-5.54a.11.11,0,0,0-.11-.06,30,30,0,0,0-7,1.48.12.12,0,0,0-.07.1l.08,6.05a.09.09,0,0,1-.16.07L37.8,18.76a.11.11,0,0,0-.12,0,29.75,29.75,0,0,0-5.83,4.13.11.11,0,0,0,0,.12l2.59,5.6a.11.11,0,0,1-.13.14l-5.9-2a.11.11,0,0,0-.12,0,30.23,30.23,0,0,0-3.62,6.08.11.11,0,0,0,0,.12l4.79,4.19a.1.1,0,0,1-.06.17L23,37.91a.1.1,0,0,0-.09.07A29.9,29.9,0,0,0,22,44.92a.1.1,0,0,0,.07.1L28.4,47a.1.1,0,0,1,0,.18l-5.84,3.26a.16.16,0,0,0,0,.11,30.17,30.17,0,0,0,2.1,6.76c.32.71.67,1.4,1,2.08a.1.1,0,0,0,.06,0L52,68.16H52l26.34-8.78a.1.1,0,0,0,.06-.05,30.48,30.48,0,0,0,3.11-8.88.1.1,0,0,0-.05-.11l-5.83-3.26A.1.1,0,0,1,75.68,46.9Z"/>
      ...
      */}
      ...
      <h1>Remix Rewards</h1>
  <div><h3>Remix Project rewards contributors, beta testers, and UX research participants with NFTs deployed on Optimism. 
  <br/>Remix Reward holders are able to mint a second “Remixer” user NFT badge to give to any other user of their choice (friendlier UX coming soon). 
  <br/>This feature is a way for rewarded Remix contributors to help grow our user base into a larger and more genuine open source community of practice.
  <br/>
  <br/>
Remix Rewards are currently not transferable. <br/>This feature leaves open the possibility of granting holders proportional voting power to help the community decide on new features for the IDE and/or other issues governing the development of the Remix toolset.
<br/>
Input a wallet address to see the Remix Rewards it holds:
      ...
      <div style={{ padding: 16, width: '100%', color: '#007aa6', paddingTop: '0px'}}>
        ...
        <TextField variant="outlined" sx={{ marginTop: 2, color:'#007aa6' }} label="Address or ENS name"
        onChange={(e) => {
       ...
       eventBadges.reverse().map((event) => {
          ...
          return (
            <Card title={'owner - ' + title} style={{margin: '12px', width: '500px'}}>
              ...
              <br/> 
              <a href={txLink} target='_blank'>view transaction</a>            
            </Card>
          )
        })
      }</div>
