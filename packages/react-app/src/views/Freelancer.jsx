        ...
        <div>
            ...
            <div className="container-fluid py-3">
                ...
                <div className="col-8">
                    ...
                    <input type="text" className="form-control" placeholder="Enter contract address or leave blank to deploy a new one" id="txt-contract-address" />
                    </div>
                </div>
                <div className="col-4">
                    <a tabindex="0"  className="btn btn-primary btn-lg" onclick="App.btnGo()" 
            ...
            <button className="btn btn-primary btn-lg" type="button" id="btn-End-Project" onclick="App.btnEndProject()">End Project</button>
