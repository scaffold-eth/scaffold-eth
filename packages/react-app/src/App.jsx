...
import { Header, Account, Faucet, Ramp, Contract, GasGauge, SnatchPage } from "./components";
      ...
      <BrowserRouter>
        ...
        <Switch>
          <Route exact path="/snatch">
            <SnatchPage mainnetProvider={mainnetProvider} localProvider={localProvider} tx={tx} />
          </Route>
