...
function App(props) {
  ...
  const someRandomRinkebyDAIBalance = useContractReader(readContracts, "DAI", "balanceOf", [
    "0x206DA619F41c702895742444B17db92ac12d1a03",
  ]);
  console.log("someRandomRinkebyDAIBalance",someRandomRinkebyDAIBalance)
