...
export default function TokenEvents({ contracts, contractName, eventName, localProvider, mainnetProvider, startBlock }) {
        ...
        renderItem={item => {
          ...
          return (
            <List.Item key={item.blockNumber + "_" + item.args.sender + "_" + item.args.purpose}>
              <Col >
                Block:{parseInt(item.blockNumber)} {" "}
              </Col>
              <Col >
                TokenId:{parseInt(item.args[2])} {" "}
              </Col>
              <Space >
