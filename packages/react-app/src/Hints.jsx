  ...
  return (
    <div >
      ...
      <p style={{marginTop:32}}>
        <span style={{marginRight:8}}>🔭</span>
        explore the
        <span style={{marginLeft:4,marginRight:4,backgroundColor:"#f9f9f9", padding:4, borderRadius:4, fontWeight:'bolder'}}>
          🖇 hooks
        </span>
        and
        <span style={{marginLeft:4,backgroundColor:"#f9f9f9", padding:4, borderRadius:4, fontWeight:'bolder'}}>
      ...
      <p style={{marginTop:32}}>
        ...
        <span style={{margin:4,backgroundColor:"#f9f9f9", padding:4, borderRadius:4, fontWeight:'bolder'}}>
          useBalance()
        </span> hook keeps track of your balance: <b>{ethers.utils.formatEther(props.yourLocalBalance)}</b>
      </p>
      ...
      <p style={{marginTop:32}}>
        ...
        <span style={{margin:4,backgroundColor:"#f9f9f9", padding:4, borderRadius:4, fontWeight:'bolder'}}>
          price
        </span> that is loaded with the
        <span style={{margin:4,backgroundColor:"#f9f9f9", padding:4, borderRadius:4, fontWeight:'bolder'}}>
          usePrice
        </span> hook with the current value: <b>${ props.price }</b>
      </p>
      ...
      <p style={{marginTop:32}}>
        ...
        <span style={{marginLeft:4,backgroundColor:"#f9f9f9", padding:4, borderRadius:4, fontWeight:'bolder'}}>
          <Address value={props.address} minimized={true} /> {props.address}
        </span>
      </p>
      ...
      <div style={{padding:128}}><a target="_blank" href="https://github.com/austintgriffith/scaffold-eth">🛠</a></div>
    </div>
  );
}
