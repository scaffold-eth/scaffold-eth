...
export default function useMultiCall(contracts, params = {}, provider) {
  ...
  const multicall = useMemo(() => {
    return provider ? new Multicall({ ethersProvider: provider, tryAggregate: false, multicallCustomContractAddress: '0x7Cbc68dc836e05833CF88b6676715dB805B5c0a2', }) : null;
  }, [provider]);
