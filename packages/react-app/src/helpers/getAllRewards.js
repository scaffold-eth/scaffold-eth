...
export async function getAllRewards(contractAddress, provider) {
  let result = await fetch(provider, {
    ...
    body: JSON.stringify({"jsonrpc":"2.0","method":"eth_getLogs","params":[{"address": "" + contractAddress + "", "topics": ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"], "fromBlock": "0x58B5AB"}],"id":0})
  })
