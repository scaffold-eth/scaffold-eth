...
export default function NFTLicense(): JSX.Element {
  return (
    <Box
      overflowY="auto"
      height="10rem"
    ...
    >
      ...
      <Text mb="3">Last Revised: November 5, 2018</Text>

      <Text mb="3" fontWeight="bold">
        0. Background; Instructions for Use.
      </Text>
      <Text mb="3">
        The NFT License (this “License”) is built to support applications for
        blockchain technologies, and to help clarify a user’s rights in artistic
        overlays as the owner of a non-fungible token (“NFTs”).
      </Text>

      <Text mb="3">
        Dapper Labs Inc. (“DLI”) created this License as an open-source resource
        for the wider community to encourage adoption of the ERC-721 standard.
        DLI’s goal is to positively shape the future of NFTs for creators of
        blockchain-based art (each, for the purposes of this License, a
        “Creator”) by demystifying the associated user rights while empowering
        Creators to license their work at scale.
      </Text>

      <Text mb="3">
        DLI intends to use this License in each of its current and upcoming apps
        (including CryptoKitties®) to help ensure that NFT owners enjoy broad
        and meaningful rights in the art associated with their purchased NFTs.
        DLI encourages other Creators to adopt this License as well.
      </Text>

      <Text mb="3">
        When a Creator leverages this License, the Creator should replace the
        word “Creator” with the name of its company or organization and add a
        contact email in section 5. Other than the foregoing modification, DLI
        does not permit other changes to this License. If a Creator wishes to
        make other changes to this License, it may not refer to the resulting
        license as the NFT License, or any variant thereof. Nothing in this
        License gives a Creator or any third party any rights in or to the
        names, marks, or logos of Dapper Labs Inc. (including, without
        limitation, the right to use the “NFT License” mark), or in or to any
        intellectual property rights of DLI, its subsidiaries or affiliates, all
      ...
      <Text mb="3">“Purchased NFT” means an NFT that you Own.</Text>
      ...
      <Text mb="3">
        You acknowledge and agree that Creator (or, as applicable, its
        ...
        Creator reserves all rights in and to the Art not expressly granted to
        you in this License.
      </Text>
      ...
      <Text mb="3">
        a. General Use. Subject to your continued compliance with the terms of
        this License, Creator grants you a worldwide, non-exclusive,
        non-transferable, royalty-free license to use, copy, and display the Art
        for your Purchased NFTs, along with any Extensions that you choose to
        ...
        your NFTs, provided that the website/application cryptographically
      ...
      <Text mb="3">
        b. Commercial Use. Subject to your continued compliance with the terms
        of this License, Creator grants you a limited, worldwide, non-exclusive,
        ...
        revenue each year. For the sake of clarity, nothing in this Section 3.b
        will be deemed to restrict you from (i) owning or operating a
        marketplace that permits the use and sale of NFTs generally, provided
        ...
        display the Art for their Purchased NFTs to ensure that only the actual
        ...
        even where such revenue is in excess of $100,000 per year.
      </Text>
      ...
      <Text mb="3">
        ...
        to do any of the foregoing without Creator’s express prior written
        ...
        the license granted from the owner of the Third Party IP, Creator may
        need to pass through additional restrictions on your ability to use the
        Art; and (z) to the extent that Creator informs you of such additional
      ...
      <Text mb="3">
        ...
        must send an email to Creator at ____________ within fifteen (15) days,
        with the phrase “NFT License - Commercial Use” in the subject line,
        requesting a discussion with Creator regarding entering into a broader
        license agreement or obtaining an exemption (which may be granted or
        withheld in Creator’s sole and absolute discretion). If you exceed the
        scope of the license grant in Section 3.b without entering into a
        broader license agreement with or obtaining an exemption from Creator,
        you acknowledge and agree that: (i) you are in breach of this License;
        (ii) in addition to any remedies that may be available to Creator at law
        or in equity, the Creator may immediately terminate this License,
        without the requirement of notice; and (iii) you will be responsible to
        reimburse Creator for any costs and expenses incurred by Creator during
        the course of enforcing the terms of this License against you.
      </Text>
    </Box>
  )
}
